...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:${C.bg};">
  <tr>
    <td align="center" style="padding:28px 12px;">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 2px 12px rgba(0,61,153,.10);">
        ...
        <tr>
          <td style="background:${C.green};padding:26px 40px;font-family:Arial,Helvetica,sans-serif;text-align:center;">
            ...
            <div style="font-size:12px;color:#d6e4ff;margin-top:8px;line-height:1.7;">

  ...
  <tr>
    <td align="center" style="padding:40px 16px;">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:100%;width:600px;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 8px 24px rgba(0,61,153,0.08);">
        ...
        <!-- Logo Header com Fundo Azul Gradiente -->
        <tr>
          <td style="background:linear-gradient(135deg,#003D99 0%,#0052CC 100%);padding:36px 40px;text-align:center;">
            <img src="{{logoUrl}}" width="180" alt="{{companyName}}" style="display:block;max-width:180px;height:auto;border:0;margin:0 auto;">
          </td>
        </tr>

// Envio de emails via Resend — Ambev S.A
...
const SENDER_NAME = "Ambev S.A"; // nome fixo do remetente (ignora SENDER_NAME do ambiente)
// Sem domínio verificado no Resend, onboarding@resend.dev só entrega para o email da própria conta.
const SENDER_EMAIL = process.env.SENDER_EMAIL || "onboarding@resend.dev";
const REPLY_TO = process.env.REPLY_TO || "";
const COMPANY_NAME = "Ambev S.A"; // nome fixo da empresa nos emails
const CONTACT_EMAIL = "faleconosco@ambev.com"; // email fixo de contato
